...
async function getLocationWithDetails(uuid: string): Promise<LocationDetail | null> {
  ...
  return {
    ...
    confidence_score: locationRow.confidence_score,
    last_event_at: locationRow.last_event_at,
    last_confirmed_at: locationRow.last_confirmed_at ?? null,
    last_negative_at: locationRow.last_negative_at ?? null,
    confirm_count: locationRow.confirm_count,
    negative_count: locationRow.negative_count,
    author,
    comments,
    images,
  };
